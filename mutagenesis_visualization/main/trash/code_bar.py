...
def plot_position(self, position, output_file: Union[None, str, Path] = None, **kwargs):
    """
...
def plot_library_representation(self, output_file: Union[None, str, Path] = None, **kwargs):
    """
